...
<div id="Tags" class="tabcontent">
  ...
  <?php foreach($tag as $tags) { ?>
    <li><a href="index.php">#<?=$tags['tags_name']?></a><br><br></li>    
    <?php } ?>
  <?php endif; ?>
  </ul> 
</div>
...
<div id="Locations" class="tabcontent">
  ...
  <?php foreach($location as $locations) { ?>
    <li class="search_location"><a href=""><img src="./assets/icon_location.png" alt="location-icon"><?=$locations['upload_location']?></a><br><br></li>    
    <?php } ?>
  <?php endif; ?>
  </ul> 
